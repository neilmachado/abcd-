...
reddit = praw.Reddit(client_id="aFLTQoiP5rq1TQ", #14 letter key
                     client_secret="nRUEk03DhDJgHwp6xuZGa7sVmbS1jA", #27 letter key
                     password="Then_Cauliflower_548",
                     user_agent="testscript by u/Then_Cauliflower_548",
                     username="Then_Cauliflower_548")
