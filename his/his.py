...
reddit = praw.Reddit(client_id="saIU582BNoR7Dw", #14 letter key
                     client_secret="nXLLuS8OkUySxgSCxdzvNYoj4ZcFwg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/historical-fun-3562",
                     username="historical-fun-3562")
