...
reddit = praw.Reddit(client_id="naVJ-sLVDXi1BA", #14 letter key
                     client_secret="wGrosjNji2eQe1t8nA7l8jla7XHnPA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/psychol_ad",
                     username="psychol_ad")
