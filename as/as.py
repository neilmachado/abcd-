...
reddit = praw.Reddit(client_id="wtwv4Kc0TMTF3Q", #14 letter key
                     client_secret="L9TAo2Ct7lppYlRI6X18zmX7C7-jsA", #27 letter key
                     password="Accurate-Collection2",
                     user_agent="testscript by u/Accurate-Collection2",
                     username="Accurate-Collection2")
