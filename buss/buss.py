...
reddit = praw.Reddit(client_id="k4qWQrOxLNcxcQ", #14 letter key
                     client_secret="Eaas2XntAmC2oxHQQS7JdM4_cz9kcw", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/business-add",
                     username="business-add")
