...
reddit = praw.Reddit(client_id="C-pvv0Mdni2dDg", #14 letter key
                     client_secret="gCZMO7HqyNbDwjFywuREXnd-UlfmSw", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/feeling-pair-5648",
                     username="feeling-pair-5648")
