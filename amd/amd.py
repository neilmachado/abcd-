...
reddit = praw.Reddit(client_id="VX27orlThjO6Qg", #14 letter key
                     client_secret="840XtKv6JOSJl9w5NxB8u9gVx-Q2Ww", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/accomplished_add",
                     username="accomplished_add")
