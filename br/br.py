...
reddit = praw.Reddit(client_id="CcSDeURdzlCenA", #14 letter key
                     client_secret="_vN4X5uwGoyDfNaeZkW4RH2i5tnuPg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/bright-ad-471",
                     username="bright-ad-471")
