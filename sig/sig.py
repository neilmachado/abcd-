...
reddit = praw.Reddit(client_id="0SqBM3E8_RM14A", #14 letter key
                     client_secret="xa-r3hF214xIx91ckF6uOSniECVCqA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/significan-ad",
                     username="significan-ad")
