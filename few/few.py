...
reddit = praw.Reddit(client_id="qdEjT1-vSeM45A", #14 letter key
                     client_secret="HqQPOD6b7JEUGyxBwzz99Rxjq10XtQ", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Few-Relati0n",
                     username="Few-Relati0n")
